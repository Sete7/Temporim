...
class CategoriaDAO {
    ...
    public function Cadastrar(Categoria $categoria) {
        try {
            $sql = "INSERT INTO categoria (titulo, url, status, data) VALUES(:titulo, :url, :status, :data)";
            $param = array(
    ...
    public function Atualizar(Categoria $categoria) {
        try {
            $sql = "UPDATE categoria SET titulo = :titulo, url = :url, status = :status, data = :data WHERE cod = :cod";
            $param = array(
